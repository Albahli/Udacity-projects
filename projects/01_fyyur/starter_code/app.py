...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:4279@localhost:5432/fyyur'
...
def create_venue_submission():
  ...
  try:
    ...
    newVenue = Venue(
        ...
        seeking_description = request.form.get('seeking_description') if venue_seeking_talent else '',
...
def create_artist_submission():
  ...
  try:
    ...
    newArtist = Artist(
        ...
        seeking_description = request.form.get('seeking_description') if artist_seeking_venue else '',
        facebook_link = request.form.get('facebook_link'),
        image_link = request.form.get('image_link'),
        website = request.form.get('website'),
      )
